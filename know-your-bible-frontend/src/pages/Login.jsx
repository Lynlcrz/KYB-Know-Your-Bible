        ...
        <div className="bible-right-side">
          <div className="bible-login-card">
            <div className="bible-logo-container">
              <div className="bible-logo">
                <span className="bible-logo-k">K</span>
                <span className="bible-logo-y">Y</span>
                <span className="bible-logo-b">B</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bible-form">
              ...
              <div className="bible-create-account-container">
                <p>
                  ...
                  <a href="#" className="bible-create-account-link">
                    Create account
                  </a>
                </p>
